...
export default function CommitCraftPage() {
  ...
  const [result, setResult] = useState<{ message: string; type: string; scope?: string } | null>(null)
    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center gap-4">
          ...
          <span className="font-semibold">CommitCraft</span>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-8 w-full">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Paste the output of <code className="text-sm bg-muted px-1 rounded">git diff</code> or your staged changes</CardDescription>
          </CardHeader>
