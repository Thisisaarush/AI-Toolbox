...
export const CATEGORY_META = [
  { id: "dev-tools", label: "Dev Tools",  legendColor: "bg-blue-500",    count: 8 },
  { id: "personal",  label: "Personal",   legendColor: "bg-orange-500",  count: 6 },
  { id: "education", label: "Education",  legendColor: "bg-violet-500",  count: 3 },
  { id: "career",    label: "Career",     legendColor: "bg-blue-600",    count: 1 },
  { id: "creator",   label: "Creator",    legendColor: "bg-fuchsia-500", count: 1 },
